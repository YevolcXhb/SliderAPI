...
func (PaymentOrder) Fields() []ent.Field {
	return []ent.Field{
		...
		// 金额信息
		field.Float("amount").
			SchemaType(map[string]string{dialect.Postgres: "decimal(20,2)", dialect.MySQL: "decimal(20,2)"}),
		...
		field.Time("refund_at").
			Optional().
			Nillable().
			SchemaType(map[string]string{dialect.Postgres: "timestamptz", dialect.MySQL: "datetime(6)"}),
