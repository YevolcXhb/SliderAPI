...
func init() {
	...
	accountDescAccountLevel := accountFields[6].Descriptor()
	...
	groupDescScope := groupFields[12].Descriptor()
	...
	groupDescRequiredAccountLevel := groupFields[13].Descriptor()
	...
	groupDescKiroCacheEmulationEnabled := groupFields[14].Descriptor()
	...
	groupDescKiroAutoStickyEnabled := groupFields[15].Descriptor()
	...
	groupDescKiroStickySessionTTLSeconds := groupFields[16].Descriptor()
	...
	groupDescKiroCacheEmulationRatio := groupFields[17].Descriptor()
	...
	groupDescKiroEndpointMode := groupFields[18].Descriptor()
	...
	userDescRechargeBalance := userFields[5].Descriptor()
	...
	userDescInviteIncomeBalance := userFields[6].Descriptor()
	...
	userDescShareIncomeBalance := userFields[7].Descriptor()
	...
	userDescPointsBalance := userFields[8].Descriptor()
	...
	userDescPreferPointsBilling := userFields[9].Descriptor()
	...
	userDescTotalInviteIncome := userFields[10].Descriptor()
	...
	userDescTotalShareIncome := userFields[11].Descriptor()
