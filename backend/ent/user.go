...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldBalance, user.FieldFrozenBalance, user.FieldRechargeBalance, user.FieldInviteIncomeBalance, user.FieldShareIncomeBalance, user.FieldPointsBalance, user.FieldTotalInviteIncome, user.FieldTotalShareIncome, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged:
