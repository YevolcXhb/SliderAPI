...
ALTER TABLE groups
    ADD COLUMN IF NOT EXISTS allow_image_generation TINYINT(1) NOT NULL DEFAULT 0;

ALTER TABLE groups
    ADD COLUMN IF NOT EXISTS image_rate_independent TINYINT(1) NOT NULL DEFAULT 0;
