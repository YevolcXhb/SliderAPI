...
ON groups(fallback_group_id_on_invalid_request);  -- [MariaDB] 去掉部分索引 WHERE

-- 添加字段注释
-- [MariaDB: COMMENT ON 已禁用] COMMENT ON COLUMN groups.fallback_group_id_on_invalid_request IS '无效请求兜底使用的分组 ID';
