ALTER TABLE shop_products
    ADD COLUMN IF NOT EXISTS allow_balance_payment TINYINT(1) NOT NULL DEFAULT 1,
    ADD COLUMN IF NOT EXISTS allow_platform_payment TINYINT(1) NOT NULL DEFAULT 1;
