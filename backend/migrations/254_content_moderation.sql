...
ALTER TABLE content_moderation_logs ADD COLUMN IF NOT EXISTS auto_banned TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE content_moderation_logs ADD COLUMN IF NOT EXISTS email_sent TINYINT(1) NOT NULL DEFAULT 0;
