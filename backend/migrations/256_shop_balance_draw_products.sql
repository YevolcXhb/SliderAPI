ALTER TABLE shop_products
    ...
    ADD COLUMN IF NOT EXISTS balance_only TINYINT(1) NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS draw_enabled TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS shop_draw_cycles (
    ...
    remaining_amounts JSON NOT NULL DEFAULT '[]',
...
CREATE TABLE IF NOT EXISTS shop_balance_ledger (
    ...
    -- [MariaDB] CHECK referencing FK column (draw_cycle_id) not supported; skipped
