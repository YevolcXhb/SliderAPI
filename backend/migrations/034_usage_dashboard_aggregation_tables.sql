...
-- [MariaDB: COMMENT ON 已禁用] COMMENT ON TABLE usage_dashboard_hourly IS 'Pre-aggregated hourly usage metrics for admin dashboard (UTC buckets).';
-- [MariaDB: COMMENT ON 已禁用] COMMENT ON COLUMN usage_dashboard_hourly.bucket_start IS 'UTC start timestamp of the hour bucket.';
-- [MariaDB: COMMENT ON 已禁用] COMMENT ON COLUMN usage_dashboard_hourly.computed_at IS 'When the hourly row was last computed/refreshed.';
...
-- [MariaDB: COMMENT ON 已禁用] COMMENT ON TABLE usage_dashboard_daily IS 'Pre-aggregated daily usage metrics for admin dashboard (UTC dates).';
-- [MariaDB: COMMENT ON 已禁用] COMMENT ON COLUMN usage_dashboard_daily.bucket_date IS 'UTC date of the day bucket.';
-- [MariaDB: COMMENT ON 已禁用] COMMENT ON COLUMN usage_dashboard_daily.computed_at IS 'When the daily row was last computed/refreshed.';
