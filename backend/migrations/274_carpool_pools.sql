...
CREATE INDEX IF NOT EXISTS idx_carpool_pools_owner_user_id ON carpool_pools(owner_user_id);  -- [MariaDB] partial index WHERE removed
CREATE INDEX IF NOT EXISTS idx_carpool_pools_public_hall ON carpool_pools(status, visibility, platform);  -- [MariaDB] partial index WHERE removed
...
CREATE UNIQUE INDEX IF NOT EXISTS uniq_carpool_join_requests_pool_user_active
    ON carpool_join_requests(pool_id, user_id);  -- [MariaDB] partial index WHERE removed
CREATE INDEX IF NOT EXISTS idx_carpool_join_requests_pool_id ON carpool_join_requests(pool_id);  -- [MariaDB] partial index WHERE removed
CREATE INDEX IF NOT EXISTS idx_carpool_join_requests_user_id ON carpool_join_requests(user_id);  -- [MariaDB] partial index WHERE removed
...
CREATE INDEX IF NOT EXISTS idx_carpool_members_pool_id ON carpool_members(pool_id);  -- [MariaDB] partial index WHERE removed
CREATE INDEX IF NOT EXISTS idx_carpool_members_user_id ON carpool_members(user_id);  -- [MariaDB] partial index WHERE removed