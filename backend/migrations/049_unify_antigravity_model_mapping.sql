...
-- [MariaDB] (x - 'a' - 'b') || obj -> JSON_MERGE_PATCH(JSON_REMOVE(COALESCE(x,'{}'), 路径...), obj)
UPDATE accounts
SET credentials = JSON_MERGE_PATCH(
    JSON_REMOVE(COALESCE(credentials, '{}'), '$.model_whitelist', '$.model_mapping'),
    ('{
  "model_mapping": {
