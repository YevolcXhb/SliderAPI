...
VALUES (?, 'wechat', 'wechat-main', 'openid-synthetic', '{"backfill_source":"synthetic_email"}')
...
VALUES (?, 'wechat', 'wechat-main', 'oa', 'wx-app-conflict', 'openid-channel-conflict', '{}')
