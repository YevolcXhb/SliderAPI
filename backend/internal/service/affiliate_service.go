...
// AffiliateInviteRewardExtensionResult reports how many windows were extended.
type AffiliateInviteRewardExtensionResult struct {
	Affected int64 `json:"affected"`
}

// AdminExtendInviteRewards extends active invite reward windows (site / inviter scope).
