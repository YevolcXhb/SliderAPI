...
type opsRepoMock struct {
	// err 让重试相关方法统一返回错误，便于覆盖失败分支。
	err error
	// 以下字段记录重试相关调用，供断言使用。
	retryAttempt            *OpsRetryAttempt
	retryAttempts           []*OpsRetryAttempt
	insertRetryAttemptID    int64
	insertRetryAttemptInput *OpsInsertRetryAttemptInput
	updateRetryAttemptInput *OpsUpdateRetryAttemptInput
...
func (m *opsRepoMock) InsertRetryAttempt(ctx context.Context, input *OpsInsertRetryAttemptInput) (int64, error) {
	...
	m.insertRetryAttemptInput = input
	return m.insertRetryAttemptID, nil
}
...
func (m *opsRepoMock) UpdateRetryAttempt(ctx context.Context, input *OpsUpdateRetryAttemptInput) error {
	...
	m.updateRetryAttemptInput = input
	return nil
}
