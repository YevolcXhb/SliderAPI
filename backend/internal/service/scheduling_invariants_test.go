...
// Grok 视频计费与 reasoning 缓存不参与调度不变量测试，仅补齐 GatewayCache 接口。
func (c *schedInvGatewayCache) SetGrokVideoPendingBilling(context.Context, string, []byte, time.Duration) error {
	return nil
}

func (c *schedInvGatewayCache) GetGrokVideoPendingBilling(context.Context, string) ([]byte, error) {
	return nil, nil
}

func (c *schedInvGatewayCache) ClaimGrokVideoBilled(context.Context, string, time.Duration) (bool, error) {
	return true, nil
}

func (c *schedInvGatewayCache) ReleaseGrokVideoBilled(context.Context, string) error {
	return nil
}

func (c *schedInvGatewayCache) SetReasoningContent(context.Context, string, string, time.Duration) error {
	return nil
}

func (c *schedInvGatewayCache) GetReasoningContent(context.Context, string) (string, error) {
	return "", ErrReasoningContentNotFound
}

// Grok 视频计费与 reasoning 缓存不参与调度不变量测试，仅补齐 GatewayCache 接口。
func (c *schedInvRedisGatewayCache) SetGrokVideoPendingBilling(context.Context, string, []byte, time.Duration) error {
	return nil
}

func (c *schedInvRedisGatewayCache) GetGrokVideoPendingBilling(context.Context, string) ([]byte, error) {
	return nil, nil
}

func (c *schedInvRedisGatewayCache) ClaimGrokVideoBilled(context.Context, string, time.Duration) (bool, error) {
	return true, nil
}

func (c *schedInvRedisGatewayCache) ReleaseGrokVideoBilled(context.Context, string) error {
	return nil
}

func (c *schedInvRedisGatewayCache) SetReasoningContent(context.Context, string, string, time.Duration) error {
	return nil
}

func (c *schedInvRedisGatewayCache) GetReasoningContent(context.Context, string) (string, error) {
	return "", ErrReasoningContentNotFound
}
