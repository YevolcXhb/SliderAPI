...
var ErrOwnedAccountAlreadyExists = infraerrors.Conflict("OWNED_ACCOUNT_ALREADY_EXISTS", "account already exists")

var ErrOwnedAccountTypeNotAllowed = infraerrors.BadRequest("OWNED_ACCOUNT_TYPE_NOT_ALLOWED", "user accounts only support OAuth or API key accounts")

var ErrOwnedAccountCredentialsInvalid = infraerrors.BadRequest("OWNED_ACCOUNT_CREDENTIALS_INVALID", "account credentials are invalid")

var ErrOwnedAccountCredentialsNotAllowed = infraerrors.BadRequest("OWNED_ACCOUNT_CREDENTIALS_NOT_ALLOWED", "user OAuth accounts cannot include API keys, custom URLs, upstream endpoints, cookies or manual session credentials")

var ErrOwnedAccountLevelNotAllowed = infraerrors.BadRequest("OWNED_ACCOUNT_LEVEL_NOT_ALLOWED", "user accounts can only set unknown, team or k12 account level")

var ErrOwnedAccountGroupPlatformMismatch = infraerrors.BadRequest("OWNED_ACCOUNT_GROUP_PLATFORM_MISMATCH", "account group platform does not match account platform")

var ErrOwnedAccountGroupValidationUnavailable = infraerrors.InternalServer("OWNED_ACCOUNT_GROUP_VALIDATION_UNAVAILABLE", "owned account group validation is unavailable")

var ErrOwnedAccountPublicPoolUnavailable = infraerrors.BadRequest("OWNED_ACCOUNT_PUBLIC_POOL_UNAVAILABLE", "public shared account pool group is not configured for this account platform")

var ErrOwnedAccountPublicPolicyUnavailable = infraerrors.BadRequest("OWNED_ACCOUNT_PUBLIC_POLICY_UNAVAILABLE", "account share policy is not configured for this public account pool")

var ErrOwnedAccountPublicValidationFailed = infraerrors.BadRequest("OWNED_ACCOUNT_PUBLIC_VALIDATION_FAILED", "public account validation failed")

var ErrOwnedAccountProxyPublicShareNotAllowed = infraerrors.BadRequest("OWNED_ACCOUNT_PROXY_PUBLIC_SHARE_NOT_ALLOWED", "accounts using a private proxy can only be private")

var ErrOwnedAccountAPIKeyPublicShareNotAllowed = infraerrors.BadRequest("OWNED_ACCOUNT_APIKEY_PUBLIC_SHARE_NOT_ALLOWED", "user API key accounts can only be private")

var ErrUserPrivateProxyLimitExceeded = infraerrors.BadRequest("USER_PRIVATE_PROXY_LIMIT_EXCEEDED", "user private proxy limit exceeded")

var ErrUserPrivateProxyInvalid = infraerrors.BadRequest("USER_PRIVATE_PROXY_INVALID", "invalid private proxy configuration")
...
const AccountLevelUnknown = domain.AccountLevelUnknown

const AccountLevelPlus = domain.AccountLevelPlus

const AccountLevelPro = domain.AccountLevelPro

const AccountLevelTeam = domain.AccountLevelTeam

const AccountLevelK12 = domain.AccountLevelK12

const AccountLevelFree = domain.AccountLevelFree
