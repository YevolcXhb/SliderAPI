...
func (r *paymentFulfillmentAffiliateRepoStub) AdminBindInviter(_ context.Context, userID, inviterID int64, _ bool) (*AffiliateSummary, error) {
	_, err := r.BindInviter(context.Background(), userID, inviterID)
	if err != nil {
		return nil, err
	}
