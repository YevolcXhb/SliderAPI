...
func (r *stubUsageLogRepo) GetUserAccountSharingDashboard(context.Context, int64, time.Time, time.Time, string, int, int) (*usagestats.AccountSharingDashboardStats, error) {
	return nil, nil
}
