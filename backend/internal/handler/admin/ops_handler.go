...
// RetryErrorRequest retries a client request from an error log.
...
func (h *OpsHandler) RetryErrorRequest(c *gin.Context) {
	...
	// Force flag is currently a UI-level acknowledgement.
	_ = req.Force
...
// RetryRequestErrorClient retries a client request.
...
// RetryRequestErrorUpstreamEvent retries a specific upstream attempt.
...
// RetryUpstreamError retries an upstream request.
