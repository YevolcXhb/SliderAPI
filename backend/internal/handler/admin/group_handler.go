...
type CreateGroupRequest struct {
	...
	Platform                  string                        `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok kimi zhipu deepseek kiro composite custom"`
...
// ReplaceGroupRateSchedules replaces time-range rate schedules for a group.
...
type ReplaceGroupRateSchedulesRequest struct {
	Entries []ReplaceGroupRateScheduleEntry `json:"entries"`
}
